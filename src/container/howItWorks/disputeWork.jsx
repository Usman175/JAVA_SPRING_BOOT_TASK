...
class DisputeWork extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
  ...
  render() {
    ...
    return (
      <>
        <section className="about_bnr2"></section>
        <section className="about_sec">
          <div className="container">
            <h3 className="title_h3 text-center">
              {languageType.DISPUTE}, {languageType.HOW_IT_WORKS}
            </h3>
            <p className="text">
...
export default connect(mapStateToProps, mapDispatchProps)(DisputeWork);
