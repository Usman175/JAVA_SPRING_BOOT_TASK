...
class HourlyWork extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
        ...
        <section className="about_sec">
          <div className="container">
            <h3 className="title_h3 text-center">
              {languageType.HOURLY_WORK}, {languageType.HOW_IT_WORKS}
            </h3>
            <p className="text">
...
export default connect(mapStateToProps, mapDispatchProps)(HourlyWork);
