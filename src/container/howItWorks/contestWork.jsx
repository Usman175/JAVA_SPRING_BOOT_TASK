...
class ContestWork extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
      ...
      <> 
        <section className="about_sec">
          <div className="container">
            <h3 className="title_h3 text-center">CONTEST, HOW IT WORKS!</h3>
            <p className="text">
              마일스톤 형식의 프로젝트는 프리랜서와 전체 프로젝트 금액과 시간을
              산정한 후, 그에 따라서 대금을 지급하는 형식의 프로젝트입니다. 예를
              들어 전체 프로젝트가 US$10,000.00이라고 했을때 이를 주당 또는
              합의된 기간에 따라 대금을 분할하여 프리랜서가 지급한 업무를
              확인하고 대금을 지급함으로써 프로젝트를 안전하게 진행시킬수
              있습니다.
            </p>
            <p className="text">
...
export default connect(mapStateToProps, mapDispatchProps)(ContestWork);
