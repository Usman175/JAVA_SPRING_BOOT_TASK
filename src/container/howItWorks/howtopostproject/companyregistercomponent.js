...
function CompanyRegisterComponent(props) {
  return (
    <>
    <section className="about_sec"> 
      <div className="container">
        <h3 className="title_h3 text-center">How to Post A Project</h3>
        <p className="text">
          마일스톤 형식의 프로젝트는 프리랜서와 전체 프로젝트 금액과 시간을
          산정한 후, 그에 따라서 대금을 지급하는 형식의 프로젝트입니다. 예를
          들어 전체 프로젝트가 US$10,000.00이라고 했을때 이를 주당 또는 합의된
          기간에 따라 대금을 분할하여 프리랜서가 지급한 업무를 확인하고 대금을
          지급함으로써 프로젝트를 안전하게 진행시킬수 있습니다.
        </p>
        <p className="text">
          프로젝트 관리툴을 활용하여 프로젝트를 에피소드와 스토리로 좀 더
          세분하여 예산을 산정하고 타스크 관리 및 참여 인원을 관리하며 전체
          프로젝트의 프로세스를 관리하실수 있습니다. 전체 기획이 완성되어
          디테일한 부분까지 요구사항이 확정되었다면 대형 프로젝트에 적용하기에
          매우 좋은 프로젝트 형태입니다.
        </p>
        <p className="text"></p>
        ...
        <div className="blog_box">
          <div className="media">
            ...
            <div className="media-body">
              ...
              <p className="blog_info">
                ...
                상품이 우리의 삶까지 변화시킬 수 있다고 믿습니다. 내가 먹고 쓰는
                것이 곧 ‘나’이니까요. 안정성, 맛, 상업성 등 여러 면에서
          ...
          <div className="media">
            ...
            <div className="media-body">
              ...
              <p className="blog_info">
                ...
                고객님께 전해드리는 것. 컬리가 배송 시간부터 포장재까지 물류의
                모든 것을 혁신한 이유이자, 컬리의 물류가 가지는 가치입니다.
              </p>
              <a href="#">
          ...
          <div className="media">
            ...
            <div className="media-body">
              ...
              <p className="blog_info">
                소비자에게는 품질만큼 가격도 좋은 상품의 기준이 됩니다. 하지만
                생산자가 배제된 최저가 정책은 정답이 될 수 없습니다. 컬리가 업계
                최초로 도입한 100% 생산자 직거래 및 매입 방식은 유통 중 발생하던
                재고 손실을 최소화해 동일 품질의 상품을 가장 낮은 가격에 판매할
                수 있도록 해줍니다.
              </p>
              <a href="#">
          ...
          <div className="media">
            ...
            <div className="media-body">
              ...
              <p className="blog_info">
                ...
                고객님의 현재는 물론 미래까지도 세심하게 케어하고 싶은 컬리의
                의지입니다.
              </p>
              <a href="#">
                고객만족보장제도 더 알아보기{" "}
          ...
          <div className="media">
            ...
            <div className="media-body">
              ...
              <p className="blog_info">
                좋은 먹거리는 깨끗한 환경에서, 좋은 상품은 생산자에게 합리적인
                유통 구조에서 시작되기에 마켓컬리는 환경, 상품, 사람의 선순환을
                이루는 지속 가능한 유통을 고민합니다. 지속 가능한 상품 선정부터
                생산자와의 동반 성장, 친환경 포장재 개발, 사회에 대한 기여까지
                장기적으로 소비자와 생산자 모두에게 옳은 일을 하기 위해
                노력합니다.
              </p>
              <a href="#">
                지속 가능한 유통 더 알아보기{" "}
          ...
          <div className="media">
            ...
            <div className="media-body">
              ...
              <p className="blog_info">
                ...
                문제들을 넘겨보지 않고, 주도적으로 문제를 해결해나가며 컬리와
                함께 의미있는 변화를 이끌어나갈 당신을 기다립니다.
              </p>
              <a href="#">
                컬리의 인재상 더 알아보기{" "}
