...
class WorkAtOffice extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
      ...
      <>
        ...
        <section className="about_sec">
          <div className="container">
            <h3 className="title_h3 text-center">OFFICE WORK, HOW IT WORKS?</h3>
            <p className="text">
...
export default connect(mapStateToProps, mapDispatchProps)(WorkAtOffice);
