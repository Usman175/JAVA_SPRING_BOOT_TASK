...
import ProjectCardbox from "./contestcardbox";
...
class ContestFeaturedPosts extends Component {
  ...
  async bindAllProject(lastPkEvaluated, move, projectType) {
    ...
    let result = await request(
      `${ENDPOINT[sessionStorage.userType==="Client"?"GetClientsContest":"GetFreelancersContest"]}` + queryString,
      getOptions({})
    );
