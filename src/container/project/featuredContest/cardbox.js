...
class ProjectCardbox extends Component {
  ...
  handleProjectTitleClick = (selectedProject) => {
    ...
    this.props.history.push(
      "/project-detail-for-freelance?projectId=" + selectedProject.projectId
    );
  };
    ...
    return (
      <>
        <div
          ...
          className="card_box featuredContestCards"
            ...
            <div className="col-md-4">
              <div className="project_detail projects-card-detail-right-area projects-card-detail-right-areaPcView">
                <div className="justify-content-between project_no">
                  ...
                  <img
                            src={selectedProject.isContestGuaranteed?
                              "https://dhihitu47nqhv.cloudfront.net/icons/awardGuarnteee.svg":"https://dhihitu47nqhv.cloudfront.net/icons/verifiedPayment.svg"
                            }
                          />{" "}
                  </div>
                </div>
